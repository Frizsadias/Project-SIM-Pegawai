...
// edit
$(document).on("click", ".edit_riwayat_orang_tua", function () {
    var _this = $(this).parents("tr");
    $("#e_id_ortu").val(_this.find(".id").text());
    ...
    $("#e_dokumen_akta_lahir_anak").val(
        _this.find(".dokumen_akta_lahir_anak").text()
    );
    $("#e_hidden_dokumen_akta_lahir_anak").val(
        _this.find(".dokumen_akta_lahir_anak").text()
    );
