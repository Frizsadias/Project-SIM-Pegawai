    ...
    public function up()
    {
        DB::unprepared('
            ...
            BEGIN
                ...
                lokasi_kerja=NEW.lokasi_kerja,gol_ruang_awal=NEW.gol_ruang_awal,gol_ruang_akhir=NEW.gol_ruang_akhir,
                tmt_golongan=NEW.tmt_golongan,gaji_pokok=NEW.gaji_pokok,masa_kerja_tahun=NEW.masa_kerja_tahun,
                masa_kerja_bulan=NEW.masa_kerja_bulan,no_spmt=NEW.no_spmt,tanggal_spmt=NEW.tanggal_spmt,kppn=NEW.kppn
            WHERE id=OLD.id;
            END
        ');
    }
