...
class CreateGenerateUserIdProfilTable extends Migration
{
     /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('
            ...
            BEGIN
                INSERT INTO profil_pegawai(user_id) VALUES (NEW.user_id);
                INSERT INTO profil_pegawais(user_id) VALUES (NEW.user_id);
