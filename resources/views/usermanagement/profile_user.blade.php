                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="small doj text-muted">Tanggal Bergabung : {{ Session::get('join_date') }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="#emp_profile" data-toggle="tab" class="nav-link active">Profil</a></li>
                        </ul>
                    </div>
                </div>
            </div>
