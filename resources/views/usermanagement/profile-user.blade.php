                                ...
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        @foreach ($data_kgb as $sqlKGB => $result_kgb)
                                            <tr>
                                                <!-- <td>{{ ++$sqlKGB }}</td> -->
                                                <td class="id"><center>{{ $result_kgb->id }}</center></td>
                                ...
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        @foreach ($riwayatPMK as $sqlPMK => $result_pmk)
                                            <tr>
                                                <!-- <td>{{ ++$sqlPMK }}</td> -->
                                                <td class="id"><center>{{ $result_pmk->id }}</center></td>
                                                ...
                                                <td class="dokumen_pmk"><center><a href="{{ asset('assets/DokumenPMK/' . $result_pmk->dokumen_pmk) }}" target="_blank"></a></center></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        @foreach ($riwayatOrtu as $sqlOrtu => $result_Ortu)
                                            <tr>
                                                ...
                                                <td class="tanggal_meninggal"><center>@if($result_Ortu->tanggal_meninggal){{ \Carbon\Carbon::parse($result_Ortu->tanggal_meninggal)->formatLocalized('%d %B %Y') }}@endif</center></td>
                                                ...
                                                <td class="pas_foto_ibu"><center><a href="{{ asset('assets/DokumenPasFotoIbu/' . $result_Ortu->pas_foto_ibu) }}" target="_blank"></a></center></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dokumen_akta_kelahiran"><center><a href="{{ asset('assets/DokumenAktaKelahiran/' . $result_anak->dokumen_akta_kelahiran) }}" target="_blank"></a></center></td>
                                            <td class="pas_foto_anak"><center><a href="{{ asset('assets/DokumenPasFotoAnak/' . $result_anak->pas_foto) }}" target="_blank"></a></center></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('user/profile/pegawai/edit') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Ruangan <span class="text-danger">*</span></label><br>
