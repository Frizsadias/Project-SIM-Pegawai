...
@section('content')
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <!-- Search Filter -->
                <form action="{{ route('layanan/cuti/cari/super-admin') }}" method="GET" id="search-form">
                    <div class="row filter-row">
                        <div class="col-sm-6 col-md-3">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#cetakDokumenRekomendasi').on('click', function ()
                {
                    ...
                    if (selectedCutiId)
                    {
                        const url = "{{ route('layanan-cuti-super-admin-rekomendasi', ['id' => ':id']) }}".replace(':id', selectedCutiId);
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#cetakDokumenKelengkapan').on('click', function ()
                {
                    ...
                    if (selectedCutiId)
                    {
                        const url = "{{ route('layanan-cuti-super-admin-kelengkapan', ['id' => ':id']) }}".replace(':id', selectedCutiId);
                        window.open(url, '_blank');
                    }
                });
            });
