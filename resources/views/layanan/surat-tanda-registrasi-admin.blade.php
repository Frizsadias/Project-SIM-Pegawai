...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        ...
        {{-- <div class="row filter-row">
            ...
            <div class="col-sm-6 col-md-3">
                <button id="cetakDokumenPerjanjian" class="btn btn-success"><i class="fa-solid fa-file-pdf"></i> Dokumen
                    Perjanjian</button>
            </div>
        </div><br> --}}
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit_str" href="#" data-toggle="modal"
                                                    ...
                                                    Edit</a>
                                                <a class="dropdown-item delete_str" href="#"
                                                    data-toggle="modal" data-target="#delete_str"><i
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="jenis_kelamin"
                                        name="jenis_kelamin" placeholder="Jenis kelamin otomatis terisi" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-form-label">Perguruan Tinggi <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="pendidikan_terakhir"
                                        name="pendidikan_terakhir" placeholder="Pendidikan tinggi otomatis terisi"
                                        readonly>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/suratTandaRegistrasi.js') }}"></script>
@endsection
@endsection
