                                ...
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dokumen_kelengkapan_user">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        @foreach($data_pribadi_kepalaruang as $sqlcutipribadi => $result_cuti_pribadi)
                                        <tr>
                                            ...
                                            <td class="dokumen_kelengkapan">
                                                <a href="{{ asset('assets/DokumenKelengkapan/' . $result_cuti_pribadi->dokumen_kelengkapan) }}" target="_blank"></a>
                                            </td>
                                                ...
                                                <div class="dropdown">
                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" id="statusDropdown" data-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        @elseif ($result_cuti_pribadi->persetujuan_kepalaruangan == 'Ditolak')
                                                            <i class="fa fa-dot-circle-o text-danger"></i>
                                                        @endif
                                                        <span class="dropdown_pengajuan">{{ $result_cuti_pribadi->persetujuan_kepalaruangan }}</span>
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="statusDropdown">
    ...
    @section('script')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.dokumen_kelengkapan_user a').each(function() {
                ...
                $('.dokumen_kelengkapan a').each(function() {
                    ...
                    @if (!empty($result_cuti_pribadi->dokumen_kelengkapan))
                        $(this).closest('td').after('<td hidden class="dokumen_kelengkapan">{{ $result_cuti_pribadi->dokumen_kelengkapan }}</td>');
                    @endif
                });
            });
        </script>
