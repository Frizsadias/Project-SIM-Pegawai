                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no_hp_orangtua_text"><center><a href="https://api.whatsapp.com/send?phone=62{{ $result_Ortu->no_hp }}" target="_blank" style="color:black">0{{ $result_Ortu->no_hp }}</a></center></td>
                                            <td class="no_telepon_orangtua_text"><center><a href="https://api.whatsapp.com/send?phone=62{{ $result_Ortu->no_telepon }}" target="_blank" style="color:black">0{{ $result_Ortu->no_telepon }}</a></center></td>
                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no_hp_pasangan_text"><center><a href="https://api.whatsapp.com/send?phone=62{{ $result_pasangan->no_hp }}" target="_blank" style="color:black">0{{ $result_pasangan->no_hp }}</a></center></td>
                                            <td class="no_telepon_pasangan_text"><center><a href="https://api.whatsapp.com/send?phone=62{{ $result_pasangan->no_telepon }}" target="_blank" style="color:black">0{{ $result_pasangan->no_telepon }}</a></center></td>
                                            <td class="email"><center>
