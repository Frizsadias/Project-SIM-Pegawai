            ...
            <div class="row align-lists-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <div class="view-icons">
                        <a href="{{ route('daftar/ruangan/pegawai/card') }}" class="grid-view btn btn-link active"><i
                                class="fa fa-th"></i></a>
                        <a href="{{ route('daftar/ruangan/pegawai/list') }}" class="list-view btn btn-link"><i
                    ...
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="{{ url('user/profile/' . $result_ruang->user_id) }}" class="avatar">
                                <img src="{{ URL::to('/assets/images/' . $result_ruang->avatar) }}"
                                    alt="{{ $result_ruang->avatar }}">
                            </a>
                        </div>
