                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table datatable" id="tableStatus">
                            ...
                            <tbody>
                                @foreach ($ref_status as $key => $items)
                                    <tr>
                                        <td>{{ ++$key }}</td>
                                        <td hidden class="id">{{ $items->id }}</td>
                                        <td class="ref_status">{{ $items->ref_status }}</td>
                                        <td class="text-right">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/status/save') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('ref_status') is-invalid @enderror" type="text"
                                    id="ref_status" name="ref_status">
                                @error('ref_status')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/status/update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Nama Status <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="status_edit" name="ref_status" value="">
                            </div>
                            <div class="submit-section">
...
@section('script')
    ...
    <script>
        $(document).on('click', '.edit_status', function() {
            ...
            $('#status_edit').val(_this.find('.ref_status').text());
        });
    </script>
    {{-- delete model --}}
    <script>
