...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        ...
        {{-- Export Excel --}}
        <form action="{{ route('export-sip-dokter') }}" method="GET">
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item delete_sip_dokter" href="#" data-toggle="modal"
                                                        data-target="#delete_sip_dokter"><i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jenis_dokumen" value="SIP Dokter" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<script>
    ...
    // Hapus SIP Dokter
    $(document).on('click', '.delete_sip_dokter', function() {
        var _this = $(this).parents('tr');
        $('.e_id').val(_this.find('.id').text());
    });
</script>
