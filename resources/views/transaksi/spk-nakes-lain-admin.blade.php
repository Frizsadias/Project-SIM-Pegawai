                            ...
                            <tbody>
                                @foreach ($data_spk_nakeslain as $sql_spk_nakeslain => $result_spk_nakeslain)
                                    <tr>
                                        ...
                                        <td class="id">{{ $result_spk_nakeslain->id }}</td>
                                        ...
                                        <td class="dokumen_sip"><a href="{{ asset('assets/DokumenSPKNakesLain/' . $result_spk_nakeslain->dokumen_sip) }}"target="_blank"></a></td>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('.dokumen_sip a').each(function() {
                    ...
                    @if (!empty($result_spk_nakeslain->dokumen_sip))
                        $(this).closest('td').after('<td hidden class="dokumen_sip">{{ $result_spk_nakeslain->dokumen_sip }}</td>');
                    @endif
                });
            });
        </script>
