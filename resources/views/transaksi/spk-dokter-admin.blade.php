        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#daftar_spk_dokter"><i
                            class="fa fa-plus"></i> Tambah SPK Dokter</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                            ...
                            @foreach ($data_spk_dokter as $sqlspk => $result_spk_dokter)
                                <tr>
                                    ...
                                    <td class="dokumen_sip">
                                        <a href="{{ asset('assets/DokumenSPKDokter/' . $result_spk_dokter->dokumen_sip) }}"
                                            target="_blank">
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit_spk_dokter" href="#"
                                                    data-toggle="modal" data-target="#edit_spk_dokter"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit</a>
                                                <a class="dropdown-item delete_spk_dokter" href="#" data-toggle="modal"
                                                        data-target="#delete_spk_dokter"><i
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('transaksi/spk-dokter/tambah-data') }}" method="POST"
    ...
    <div id="edit_spk_dokter" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('transaksi/spk-dokter/edit-data') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
