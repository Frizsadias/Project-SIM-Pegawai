...
@section('content')
                        ...
                        <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                                @foreach ($data_spk_dokter as $sqlspkdokter => $result_spkdokter)
                                    <tr>
                                        <!-- <td>{{ ++$sqlspkdokter }}</td> -->
                                        <td class="id">{{ $result_spkdokter->id }}</td>
                                        ...
                                        <td class="dokumen_sip"><a href="{{ asset('assets/DokumenSPKDokter/' . $result_spkdokter->dokumen_sip) }}" target="_blank"></a></td>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="theSelect" style="width: 100% !important" name="ruangan" id="e_ruangan">
                                            <option selected disabled>-- Pilih Ruangan --</option>
                                            @foreach($ruanganOptions as $key => $value)
                                                @if (!empty($result_spkdokter->ruangan))
                                                    <option value="{{ $key }}" {{ $key == $result_spkdokter->ruangan ? 'selected' : '' }}>{{ $value }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
    ...
    @section('script')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.dokumen_sip a').each(function() {
                    ...
                    @if (!empty($result_spkdokter->dokumen_sip))
                        $(this).closest('td').after('<td hidden class="dokumen_sip">{{ $result_spkdokter->dokumen_sip }}</td>');
                    @endif
                });
            });
        </script>
        ...
        <script>
            history.pushState({}, "", '/transaksi/spk-dokter');
        </script>

        <script>
            document.getElementById('pageTitle').innerHTML = 'Layanan SPK Dokter | Aplikasi SILK';
        </script>
