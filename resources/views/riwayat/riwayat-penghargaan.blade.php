                ...
                <div class="row filter-row">
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus select-focus">
                            <select class="theSelect form-control" style="width: 100% !important" id="jenis_penghargaan" name="jenis_penghargaan">
                            ...
                            <div class="row">
                                <div class="dropzone-box-1">
                                    ...
                                    <div class="dropzone-area-1">
                                        ...
                                        <input type="file" name="dokumen_penghargaan" id="upload-file-form-1">
