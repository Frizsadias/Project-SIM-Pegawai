...
@extends('layouts.judulorganisasi')
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="dropzone-box">
                                    ...
                                    <div class="dropzone-area">
                                        ...
                                        <input type="file" name="dokumen_organisasi" id="upload-file-form1">
    ...
    @section('script')
        ...
        <script src="{{ asset('assets/js/draganddropRiwayatOrganisasi.js') }}"></script>
