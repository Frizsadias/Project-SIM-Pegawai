				...
				<ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow flag-nav">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                            <img src="{{ URL::to('assets/img/flags/indo.png') }}" alt="" height="20"> <span>Indonesia</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
							<a href="javascript:void(0);" class="dropdown-item"><img src="{{ URL::to('assets/img/flags/indo.png') }}" alt="" height="16"> Indonesia</a>
